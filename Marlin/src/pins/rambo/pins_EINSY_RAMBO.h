...
//
#if !AXIS_DRIVER_TYPE_X(TMC2130) || !AXIS_DRIVER_TYPE_Y(TMC2130) || !AXIS_DRIVER_TYPE_Z(TMC2130)
  #error "You must set ([XYZ])_DRIVER_TYPE to TMC2130 in Configuration.h for EinsyRambo."
#endif
